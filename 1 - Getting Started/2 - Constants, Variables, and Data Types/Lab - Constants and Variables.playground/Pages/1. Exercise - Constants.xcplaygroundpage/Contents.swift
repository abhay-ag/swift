...
print("The above code does not compile because we declared friends as a \"LET\" variable which is a constant. This issue can be avoided by using \"VAR\" declarative")
/*:
