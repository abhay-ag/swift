...
var favoriteBook = Book(title: "November 9", author: "Coolen Hoover", pages: 490, price: 450)
print(favoriteBook.self)
/*:
...
var a = Laptop(yearPurchased: 2021)
var b = Laptop(yearPurchased: 2022)
/*:
...
let heightInInches = Height(heightInInches: 65.0)
print("Height in inches:", heightInInches.heightInInches)
print("Height in centimeters:", heightInInches.heightInCentimeters)

let heightInCentimeters = Height(heightInCentimeters: 170.0)
print("Height in inches:", heightInCentimeters.heightInInches)
print("Height in centimeters:", heightInCentimeters.heightInCentimeters)
...
var someonsHeight = Height(heightInInches: 65)
print(someonsHeight)
...
var myHeight = Height(heightInCentimeters: 173)
print(myHeight)
