...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser:User = User(userName: "Username", email: "Email", age: 25)
    func logIn(user:User)
    {
        print("\(User.currentUser) has logged in")
    }
}

var a = User(userName: "abc", email: "ab", age: 17)
//User.currentUser = a
 ...
 */
var b = User(userName: "B", email: "dc", age: 11)
b.logIn(user: b)
/*:
